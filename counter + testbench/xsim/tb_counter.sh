...
#
# Script generated by Vivado on Fri Sep 11 03:58:46 +0300 2026
# SW Build 6511674 on Tue Jun 16 11:02:23 MDT 2026
#
# Copyright 1986-2022 Xilinx, Inc. All Rights Reserved.
# Copyright 2022-2026 Advanced Micro Devices, Inc. All Rights Reserved. 
#
# Filename     : tb_counter.sh
...
#
# Usage        : tb_counter.sh
#                tb_counter.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                tb_counter.sh [-rerun]
#                tb_counter.sh [-reset_run]
#                tb_counter.sh [-clean]
#                tb_counter.sh [-reset_log]
#                tb_counter.sh [-help]
#
...
# script info
echo -e "tb_counter.sh - Script generated by export_simulation (Vivado v2026.1 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./tb_counter.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2  -L xil_defaultlib -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot tb_counter xil_defaultlib.tb_counter xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim tb_counter -key {Behavioral:sim_1:Functional:tb_counter} -tclbatch cmd.tcl -log simulate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb tb_counter.wdb xsim.dir libdpi.so)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./tb_counter.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: tb_counter.sh [-help]\n\
Usage: tb_counter.sh [-step]\n\
Usage: tb_counter.sh [-lib_map_path]\n\
Usage: tb_counter.sh [-rerun]\n\
Usage: tb_counter.sh [-reset_run]\n\
Usage: tb_counter.sh [-clean]\n\
Usage: tb_counter.sh [-reset_log]\n\
Usage: tb_counter.sh [-keep_index]\n\
Usage: tb_counter.sh [-noclean_files]\n\n\
